...
export type Literal = NumberLiteral | StringLiteral | BooleanLiteral | NullLiteral | ArrayLiteral | ObjectLiteral;
export type Expression = IdentifierNode | BindParameterNode | Literal | BinaryExpression | UnaryExpression | TernaryExpression | MemberExpression | CallExpression | RangeExpression | ArrayAccessExpression | SubqueryExpression;
export type Statement = ForStatement | LetStatement | FilterStatement | SearchStatement | SortStatement | LimitStatement | CollectStatement | WindowStatement | ReturnStatement | InsertStatement | UpdateStatement | ReplaceStatement | RemoveStatement | UpsertStatement | WithStatement;
