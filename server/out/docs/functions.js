...
exports.functionDocs = exports.FunctionDocumentation = void 0;
const fs = require("fs");
 ...
 */
function parseArgumentPattern(pattern) {
    if (!pattern || pattern === '') {
 ...
 */
function generateParameterNames(funcName, count, variadic) {
    const params = [];
...
// Singleton instance
exports.functionDocs = new FunctionDocumentation();
