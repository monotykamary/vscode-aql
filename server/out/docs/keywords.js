...
exports.getAllKeywordNames = getAllKeywordNames;
exports.getAllKeywords = getAllKeywords;
exports.getKeywordsByCategory = getKeywordsByCategory;
exports.getKeywordMarkdown = getKeywordMarkdown;
exports.KEYWORDS = {
    // Query Structure
    FOR: {
        name: 'FOR',
 ...
 */
function getKeywordInfo(name) {
    return exports.KEYWORDS[name.toUpperCase()];
}
/**
 * Get all keyword names
 */
function getAllKeywordNames() {
    return Object.keys(exports.KEYWORDS);
}
/**
 * Get all keywords
 */
function getAllKeywords() {
    return Object.values(exports.KEYWORDS);
}
/**
 * Get keywords by category
 */
function getKeywordsByCategory(category) {
    return Object.values(exports.KEYWORDS).filter(k => k.category === category);
}
/**
 * Generate markdown documentation for a keyword
 */
function getKeywordMarkdown(name) {
