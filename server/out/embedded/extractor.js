...
exports.extractEmbeddedAql = extractEmbeddedAql;
exports.isPositionInRegion = isPositionInRegion;
exports.toRegionPosition = toRegionPosition;
 ...
 */
function extractEmbeddedAql(text, languageId) {
    ...
    while ((match = simplePattern.exec(text)) !== null) {
        ...
        const alreadyCaptured = regions.some(r => (startOffset >= r.startOffset && startOffset < r.endOffset) ||
 ...
 */
function isPositionInRegion(regions, offset) {
 ...
 */
function toRegionPosition(region, absoluteOffset) {
 ...
 */
function toAbsolutePosition(region, regionLine, regionColumn) {
